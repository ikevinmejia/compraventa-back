...
export class CarMechanicalInspectionsController {
  constructor(private readonly carMechanicalInspectionsService: CarMechanicalInspectionsService) {}

  @Post()
  create(@Body() createCarMechanicalInspectionDto: CreateCarMechanicalInspectionDto) {
    return this.carMechanicalInspectionsService.create(createCarMechanicalInspectionDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateCarMechanicalInspectionDto: UpdateCarMechanicalInspectionDto) {
    return this.carMechanicalInspectionsService.update(+id, updateCarMechanicalInspectionDto);
  }
